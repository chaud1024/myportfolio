...
export const expData: ExpProps[] = [
    ...
    to: "2024. 06.",
    description:
      "Next.js, React-Query을 사용한 로딩 및 캐시 처리, 워드프레스 CMS를 통한 데이터 관리와 GraphQL을 사용한 패칭, 그리고 GSAP으로 애니메이션을 만들어 UI의 다채로움을 추가했습니다.",
    content:
      "2024년 지인의 네트워킹 행사가 있었는데, 촬영했던 사진들을 참가자들에게 공유하기 어려웠던 기억이 있었고, 매년 진행할 행사인데 지속적인 아카이빙이 필요할 것으로 파악되어 웹사이트를 제작을 기획하게 되었습니다. 한 번 구축하고 끝날 게 아니라, 사진 혹은 참가 인물들의 데이터가 새로 쌓일 것이기 때문에 별도 CMS의 필요성을 느꼈고, 많은 웹 에이전시에서 사용하는 워드프레스를 채택하여 작업했습니다. UI적으로 단조로움을 피하기 위해 GSAP으로 애니메이션을 많이 넣고자 노력했습니다. 또한 상업 웹사이트 수준의 완성도를 높이기 위해 React-Query를 사용하여 로딩화면을 추가했습니다. 아카이브 화면에는 사진 데이터를 IntersectionObserver를 통해 무한스크롤 방법으로 구현했습니다. UX 개선을 위해 스켈레톤 로더 추가 및 애니메이션, 반응형 개선을 진행하고 있습니다.",
    site: "https://bluenote.life",
    sort: 'work'
  },
  {
    title: "웹사이트 구축",
